...
SELECT  
    ...
    od."Work",
    od."Lat.Start_Date" AS "lat_start_date",
    od."Lat.Finish_Date" AS "lat_finish_date", 
    od."Booked time" AS "booked_time",
    od."Posting date" AS "posting_date",
    od."Posted by" AS "posted_by",
    od."ActivityCode",
    od."Reason Code" AS "reason_code",
    cp."Capacity"
