WITH query_from_co_object AS (
    SELECT
        ...
        coep."KSTAR"  AS cost_element,
         CASE coep."KSTAR"
            ...
            WHEN '0000277000' THEN 'Rep & Maint Off Furn-Eqip'
            WHEN '0000279200' THEN 'Rep & Maint Work'
            WHEN '0000284500' THEN 'Contract Labor - Clerical & Admin'
            WHEN '0000284700' THEN 'Contract Labor - Engineer'
            WHEN '0000288700' THEN 'Contract Labor - General Ops & Lab'
    ...
    WHERE
        ...
        AND coep."KSTAR" IN (
             '0000271000','0000274000','0000275000','0000275100',
            '0000276000','0000277000','0000279200', '0000284500',
            '0000312000', '0000284700', '0000288700',
            '0000332000','0000332500','0000332600','0000800303'
        )
)
...
SELECT
    ...
    ROUND(SUM(CASE WHEN query_from_co_object.cost_element IN ( '0000284500', '0000284700', '0000288700' )
    ...
    ROUND(SUM(CASE WHEN query_from_co_object.cost_element IN ( '0000271000', '0000274000', '0000275000','0000275100',
    '0000276000', '0000277000', '0000279200', '0000332000' )
    ...
    ROUND(SUM(CASE 
              WHEN query_from_co_object.cost_element IN ( '0000800303' )
